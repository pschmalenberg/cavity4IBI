% Generates plots based on raw data from Biopac in .txt format
% Var1: time 
% Var2: ECG
...
% Gaussian waveform. The dataset will be plotted but not saved
...
str_data = '[2025_07_23][17h24min][ECG+HS][P01EXTRA].txt';
...
for xlim_start = 5 : 8 : total_size/10
...
% figure
% plot(time_4sec, ecg_gaussian, 'DisplayName', 'Gaussian Ground Truth')
% hold on 
% xlabel('Time(sec)', 'FontSize', font_size)
% ylabel('Amplitude', 'FontSize', font_size)
% xlim([0 4])
